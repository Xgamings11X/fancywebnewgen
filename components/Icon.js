...
const PATHS = {
  ...
  'face-frown':     ['<circle cx="12" cy="12" r="9"/>', '<path d="M8 9h.01M16 9h.01M8.5 17c1.9-2.2 5.1-2.2 7 0"/>'],
  'face-concerned': ['<circle cx="12" cy="12" r="9"/>', '<path d="M8 9h.01M16 9h.01M9 15c1.5-1.1 4.5-1.1 6 0"/>'],
  'face-meh':       ['<circle cx="12" cy="12" r="9"/>', '<path d="M8 9h.01M16 9h.01M8.5 15h7"/>'],
  'face-smile':     ['<circle cx="12" cy="12" r="9"/>', '<path d="M8 9h.01M16 9h.01M8.5 14c1.9 2.2 5.1 2.2 7 0"/>'],
  'face-grin':      ['<circle cx="12" cy="12" r="9"/>', '<path d="M8 9h.01M16 9h.01M8 14h8c-.7 2-2.2 3-4 3s-3.3-1-4-3Z"/>'],
  ...
  'comments':      ['<path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/>', '<line x1="9" y1="10" x2="9.01" y2="10"/>', '<line x1="12" y1="10" x2="12.01" y2="10"/>', '<line x1="15" y1="10" x2="15.01" y2="10"/>'],
